...
(layernum = 0),
  (piece = function (t) {
    if (((this.elem = null), nsDOM))
      null == t
        ? (this.elem = new Layer(1))
        : ((this.elem = new Layer(1, t.elem)),
          (this.style.visibility = "inherit")),
        (this.parent = t),
        (this.style = this.elem);
    else if (stdDOM) {
      (this.parent = null == t ? document.body : t.elem),
  ...
  (piece.prototype.fire = function (t, e, i) {
    ...
    (this.dx = o * Math.sin(s)),
      (this.dy = o * Math.cos(s) - 2),
      (this.x = t),
      (this.y = e),
      this.moveTo(t, e);
  }),
  ...
  (fo.prototype.animate = function () {
    if ((55 < this.step && (this.step = 0), 0 == this.step)) {
      ...
      for (
        this.cl = Math.floor(8 * Math.random()), i = 0;
        i < this.sp.length;
        i++
      )
        this.sp[i].fire(t, e, s);
    }
    for (this.step++, i = 0; i < this.sp.length; i++)
      this.sp[i].animate(this.step, this.cl);
  }),
  (window.onload = fireworks),
  document.write('<script src="js/firework.js"></script>');